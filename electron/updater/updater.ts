...
const getVercelUrl = (): string => {
  ...
  return process.env.NEXT_PUBLIC_VERCEL_URL || 'https://your-app.vercel.app';
};
...
): Promise<{ updated: boolean; versionInfo?: VersionInfo }> {
  try {
    console.log('Vérification des mises à jour...');
    
    // Récupérer la version distante
    const remoteResponse = await axios.get<VersionInfo>(REMOTE_VERSION_URL, {
