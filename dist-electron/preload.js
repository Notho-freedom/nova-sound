...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    createPlaylist: (name, trackIds) => ipcRenderer.invoke('playlists:create', name, trackIds),
    updatePlaylist: (id, data) => ipcRenderer.invoke('playlists:update', id, data),
    ...
    exportPlaylist: (id, format) => ipcRenderer.invoke('playlists:export', id, format),
    // Favorites
    ...
    saveEqualizerPreset: (name, bands) => ipcRenderer.invoke('equalizer:save', name, bands),
    deleteEqualizerPreset: (name) => ipcRenderer.invoke('equalizer:delete', name),
    // Lyrics
    getLyrics: (artist, title, duration) => ipcRenderer.invoke('lyrics:get', artist, title, duration),
    searchLyrics: (query) => ipcRenderer.invoke('lyrics:search', query),
    // Scrobbling
    scrobbleTrack: (track) => ipcRenderer.invoke('scrobbler:scrobble', track),
    updateNowPlaying: (track) => ipcRenderer.invoke('scrobbler:nowPlaying', track),
    ...
    disconnectScrobbler: (service) => ipcRenderer.invoke('scrobbler:disconnect', service),
    // File system
